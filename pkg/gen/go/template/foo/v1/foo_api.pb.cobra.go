...
var FooAPIClientCommand = &cobra.Command{
	Use: "fooAPI",
}

var fooAPI_CreateClientCommand = &cobra.Command{
	Use:  "create",
...
Authenticate using the Authorization header (requires transport security):
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		grpcClient := NewFooAPIClient(conn)
...
func init() {
	FooAPIClientCommand.AddCommand(fooAPI_CreateClientCommand)
	DefaultClientCommandConfig.AddFlags(fooAPI_CreateClientCommand.Flags())
}

var fooAPI_GetClientCommand = &cobra.Command{
	Use:  "get",
	Long: "Get client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	FooAPIClientCommand.AddCommand(fooAPI_GetClientCommand)
	DefaultClientCommandConfig.AddFlags(fooAPI_GetClientCommand.Flags())
}

var fooAPI_UpdateClientCommand = &cobra.Command{
	Use:  "update",
	Long: "Update client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	FooAPIClientCommand.AddCommand(fooAPI_UpdateClientCommand)
	DefaultClientCommandConfig.AddFlags(fooAPI_UpdateClientCommand.Flags())
}

var fooAPI_DeleteClientCommand = &cobra.Command{
	Use:  "delete",
	Long: "Delete client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	FooAPIClientCommand.AddCommand(fooAPI_DeleteClientCommand)
	DefaultClientCommandConfig.AddFlags(fooAPI_DeleteClientCommand.Flags())
}
